...
> Design notes for **commerce-presigned-asset-uploads** — a runnable python example that Typed Python service issuing browser upload grants for order-scoped commerce assets.
